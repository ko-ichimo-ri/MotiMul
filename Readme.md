...
Example
koichimori@DESKTOP-RFQ6374:~/thesis/MotiMul$ ./main data_negative.txt data_positive.txt
letters: ACGT
alpha: 0.05
debug: off
minsup(one-path): 4
...
koichimori@DESKTOP-RFQ6374:~/thesis/MotiMul$ ./main -w 1 data_negative.txt data_positive.txt
letters: ACGT
wild card: *
alpha: 0.05
debug: off
